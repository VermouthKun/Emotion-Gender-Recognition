...
def play_music(emotion):
    if emotion == 'Angry':
        pygame.mixer.music.load('C:/Users/anhku/Desktop/Emotion-Gender-Recognition/music/angry.mp3')
    elif emotion == 'Disgust':
        pygame.mixer.music.load('C:/Users/anhku/Desktop/Emotion-Gender-Recognition/music/disgust.mp3')
    elif emotion == 'Fear':
        pygame.mixer.music.load('C:/Users/anhku/Desktop/Emotion-Gender-Recognition/music/fear.mp3')
    elif emotion == 'Happy':
        pygame.mixer.music.load('C:/Users/anhku/Desktop/Emotion-Gender-Recognition/music/happy.mp3')
    elif emotion == 'Neutral':
        pygame.mixer.music.load('C:/Users/anhku/Desktop/Emotion-Gender-Recognition/music/neutral.mp3')
    elif emotion == 'Sad':
        pygame.mixer.music.load('C:/Users/anhku/Desktop/Emotion-Gender-Recognition/music/sad.mp3')
    elif emotion == 'Surprise':
        pygame.mixer.music.load('C:/Users/anhku/Desktop/Emotion-Gender-Recognition/music/surprise.mp3')
    pygame.mixer.music.play()

def update_frame():
    global camera_active, current_emotion
    if camera_active:
        ret, frame = cap.read()
        if ret:
            ...
            for (x, y, w, h) in faces:
                ...
                if emotion != current_emotion:
                    ...
                    threading.Thread(target=play_music, args=(emotion,)).start()
